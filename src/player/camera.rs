...
pub fn camera_follow_player(
    ...
    // Snap to pixel grid to prevent sub-pixel seams between tiles
    cam_tf.translation.x = cam_tf.translation.x.round();
    cam_tf.translation.y = cam_tf.translation.y.round();
}
