...
pub fn populate_npcs(registry: &mut NpcRegistry) {
    // ── 1. Margaret ─────────────────────────────────────────────────────────────
    {
        ...
        let npc = NpcDef {
            ...
            default_dialogue: vec![
                "Spring mornings make the bakery smell even sweeter, dear.".into(),
                "Summer mornings come early, and so does my bread, dear.".into(),
                "Autumn has me baking before sunrise, dear. Best season for crusts.".into(),
                "Winter mornings call for warm bread and warmer company, dear.".into(),
    ...
    // ── 3. Lily ──────────────────────────────────────────────────────────────────
    {
        ...
        let npc = NpcDef {
            ...
            gift_preferences: prefs,
            default_dialogue: vec![
                "Oh! I was just arranging the first spring flowers.".into(),
                "Oh! I was just arranging the brightest summer blooms.".into(),
                "Oh! I was just arranging the last flowers of autumn.".into(),
                "Oh! I was just arranging some hardy winter stems.".into(),
    ...
    // ── 8. Mayor Rex ──────────────────────────────────────────────────────────────
    {
        ...
        let npc = NpcDef {
            ...
            gift_preferences: prefs,
            default_dialogue: vec![
                "Ah, the farmer! Spring has the whole town moving again.".into(),
                "Ah, the farmer! Summer keeps Hearthfield at its busiest.".into(),
                "Ah, the farmer! Autumn is when the town shows its true abundance.".into(),
                "Ah, the farmer! Winter tests a town's spirit, and ours is holding.".into(),
    ...
    // ── 9. Sam ────────────────────────────────────────────────────────────────────
    {
        ...
        let npc = NpcDef {
            ...
            gift_preferences: prefs,
            default_dialogue: vec![
                "Hey! I've got a spring riff stuck in my head today.".into(),
                "Hey! Summer makes everything sound louder and better.".into(),
                "Hey! Autumn's got this mellow riff I can't shake.".into(),
                "Hey! Winter's perfect for writing moody guitar parts.".into(),
    ...
    // ── 10. Nora ──────────────────────────────────────────────────────────────────
    {
        ...
        let npc = NpcDef {
            ...
            gift_preferences: prefs,
            default_dialogue: vec![
                "The spring soil is waking up nicely today.".into(),
                "The summer soil is thirsty today. It wants rain.".into(),
                "The autumn soil is rich and tired in the best way.".into(),
                "Winter ground may look asleep, but it's still working.".into(),
