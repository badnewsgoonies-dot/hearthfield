...
pub fn populate_npcs(registry: &mut NpcRegistry) {
    ...
    // ── 2. Marco ─────────────────────────────────────────────────────────────────
    {
        ...
        let npc = NpcDef {
            ...
            gift_preferences: prefs,
            default_dialogue: vec![
                "Ciao! Spring herbs make the pasta sing today!".into(),
                "Ciao! Summer tomatoes are at their peak today!".into(),
                "Ciao! Autumn squash has me cooking something rich today!".into(),
                "Ciao! Winter calls for fresh pasta and a hearty sauce today!".into(),
    ...
    // ── 3. Lily ──────────────────────────────────────────────────────────────────
    {
        ...
        let npc = NpcDef {
            ...
            gift_preferences: prefs,
            default_dialogue: vec![
                "Oh! Spring finally woke the hedges, and now everyone in town wants their porch to look as cheerful as your farm fence.".into(),
                "Oh! Summer blooms fast here. Margaret says my buckets make the square smell better than Marco's lunch rush.".into(),
                "Oh! Autumn flowers are mostly gossip and seed heads. People linger longer when the air turns crisp.".into(),
                "Oh! Winter stems look plain until you bring them indoors. Then they feel brave.".into(),
                "The rain changes every bouquet. Even the flowers seem quieter when the clouds sit low over town.".into(),
                "If you ever want a bouquet for your farmhouse table, I'll tuck in something that matches the season.".into(),
            ],
            heart_dialogue,
    ...
    // ── 4. Old Tom ────────────────────────────────────────────────────────────────
    {
        ...
        let npc = NpcDef {
            ...
            gift_preferences: prefs,
            default_dialogue: vec![
                "Hmph. Spring fish are too lively for my taste.".into(),
                "Hmph. Summer's too bright for decent thinking.".into(),
                "Hmph. Autumn's the only season that knows how to settle down.".into(),
                "Hmph. Winter keeps the shoreline honest.".into(),
    ...
    // ── 5. Elena ──────────────────────────────────────────────────────────────────
    {
        ...
        let npc = NpcDef {
            ...
            gift_preferences: prefs,
            default_dialogue: vec![
                "The forge feels good in the spring chill.".into(),
                "The forge is hotter than summer already.".into(),
                "Autumn air makes the forge draft just right.".into(),
                "Winter's easier when you've got a hot forge.".into(),
    ...
    // ── 6. Mira ───────────────────────────────────────────────────────────────────
    {
        ...
        let npc = NpcDef {
            ...
            gift_preferences: prefs,
            default_dialogue: vec![
                "Welcome, welcome! Spring caravans brought in rare goods today.".into(),
                "Welcome, welcome! Summer traders carry the boldest wares.".into(),
                "Welcome, welcome! Autumn stock is full of rich colors and spice.".into(),
                "Welcome, welcome! Winter goods are rarest of all.".into(),
    ...
    // ── 7. Doc ────────────────────────────────────────────────────────────────────
    {
        ...
        let npc = NpcDef {
            ...
            gift_preferences: prefs,
            default_dialogue: vec![
                "Spring colds linger. How are you feeling today?".into(),
                "Summer heat can wear a person down. How are you feeling today?".into(),
                "Autumn wind stirs up every cough in town. How are you feeling today?".into(),
                "Winter is hard on the lungs. How are you feeling today?".into(),
    ...
    // ── 8. Mayor Rex ──────────────────────────────────────────────────────────────
    {
        ...
        let npc = NpcDef {
            ...
            gift_preferences: prefs,
            default_dialogue: vec![
                "Ah, the farmer! Spring has everyone peeking toward your fields as if crops grow faster under observation.".into(),
                "Ah, the farmer! Summer keeps Hearthfield at its busiest, and half that bustle is people inventing reasons to walk past your road.".into(),
                "Ah, the farmer! Autumn makes the town sentimental. Even Old Tom admitted your place looks respectable now.".into(),
                "Ah, the farmer! Winter tests a town's spirit, which is why I keep reminding everyone your lantern is a fine example.".into(),
                "I was just told Marco, Margaret, and Doc have each given different opinions on your work habits. That is civic engagement.".into(),
                "A healthy town requires trade, cheer, and at least one topic everyone politely pretends not to discuss. At present, that topic is your farm.".into(),
            ],
            heart_dialogue,
            is_marriageable: false,
            sprite_index: 7,
    ...
    // ── 10. Nora ──────────────────────────────────────────────────────────────────
    {
        ...
        let npc = NpcDef {
            ...
            gift_preferences: prefs,
            default_dialogue: vec![
                "The spring soil is waking up nicely today. Your east rows are catching that warmth first, if you haven't noticed.".into(),
                "The summer soil is thirsty today. If the clouds hold off much longer, half the valley will start talking to the sky.".into(),
                "Autumn soil gets rich and tired in the best way. That's when even stubborn land starts telling the truth.".into(),
                "Winter ground may look asleep, but it's still working. Same as farmers, when they're doing it right.".into(),
                "People in town keep asking how your farm is coming along. That means they're impressed, even if they pretend they're only curious.".into(),
                "Best time to walk a field is just after sunrise. You hear the birds, smell the weather, and catch problems before breakfast.".into(),
            ],
            heart_dialogue,
            is_marriageable: false,
            sprite_index: 9,
    ...
    // ── 11. Bjorn ────────────────────────────────────────────────────────────
    {
        ...
        let npc = NpcDef {
            ...
            gift_preferences: prefs,
            default_dialogue: vec![
                "Spring on the mountain smells like thawed stone and pine.".into(),
                "Summer up here still bites sharper than town air.".into(),
                "Autumn mountain air is the cleanest kind there is.".into(),
                "The winter mountain air is good today. Sharp and clean.".into(),
