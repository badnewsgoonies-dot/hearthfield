...
impl Plugin for CityOfficeWorkerPlugin {
    fn build(&self, app: &mut App) {
        app.init_state::<OfficeGameState>()
            .add_systems(Update, systems::achievement_unlock_sys::achievement_unlock_system)
            .init_resource::<resources::AchievementState>()
            .add_event::<events::AchievementProgressEvent>()
            .add_event::<events::AchievementUnlockedEvent>()
            .add_systems(Update, systems::reputation_tier_sys::reputation_tier_system)
            .add_systems(Update, systems::reputation_apply_sys::reputation_apply_system)
            .init_resource::<resources::ReputationState>()
            .add_event::<events::ReputationTierChangedEvent>()
            .add_event::<events::ReputationLostEvent>()
            .add_event::<events::ReputationGainedEvent>()
            .add_systems(Update, systems::coffee_consume_sys::coffee_consume_system)
            .add_systems(Update, systems::coffee_brew_sys::coffee_brew_system)
            .init_resource::<resources::CoffeeBrewsToday>()
            .add_event::<events::EnergyBoostedEvent>()
            .add_event::<events::CoffeeDrunkEvent>()
            .add_event::<events::CoffeeBrewedEvent>()
            .add_systems(Update, systems::meeting_attend_sys::meeting_attend_system)
            .add_systems(Update, systems::meeting_reminder_sys::meeting_reminder_system)
            .add_systems(Update, systems::meeting_scheduler_sys::meeting_scheduler_system)
            .add_systems(Update, systems::calendar_tick_sys::calendar_tick_system)
            .init_resource::<resources::MeetingQueue>()
            .init_resource::<resources::CalendarState>()
            .add_event::<events::MeetingReminderEvent>()
            .add_event::<events::MeetingSkippedEvent>()
            .add_event::<events::MeetingAttendedEvent>()
            .add_event::<events::MeetingStartingEvent>()
            .add_event::<events::MeetingScheduledEvent>()
