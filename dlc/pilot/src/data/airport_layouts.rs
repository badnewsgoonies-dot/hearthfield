    ...
    map.insert(
        ...
        AirportLayout {
            ...
            approaches: vec![
                ApproachProcedure {
                    name: "Visual 27".into(),
                    kind: ApproachKind::Visual,
                    minimum_altitude_ft: 1600,
                    minimum_visibility_nm: 3.0,
                },
                ApproachProcedure {
                    name: "RNAV 27".into(),
                    kind: ApproachKind::Rnav,
                    minimum_altitude_ft: 1400,
                    minimum_visibility_nm: 1.0,
                },
            ],
            notams: vec![Notam {
                subject: "Training".into(),
                text: "Student pilot training in progress — expect pattern traffic.".into(),
                severity: NotamSeverity::Info,
            }],
            facilities: &["Terminal", "Hangar", "Fuel", "Flight School"],
            diagram_notes:
                "Small regional airport. Two gates, single runway oriented E-W. Training-focused.",
        },
    );
    ...
    map.insert(
        ...
        AirportLayout {
            ...
            approaches: vec![
                ApproachProcedure {
                    name: "ILS 09L".into(),
                    kind: ApproachKind::IlsCatII,
                    minimum_altitude_ft: 400,
                    minimum_visibility_nm: 0.25,
                },
                ApproachProcedure {
                    name: "Visual 27R".into(),
                    kind: ApproachKind::Visual,
                    minimum_altitude_ft: 1000,
                    minimum_visibility_nm: 3.0,
                },
                ApproachProcedure {
                    name: "RNAV 09L".into(),
                    kind: ApproachKind::Rnav,
                    minimum_altitude_ft: 600,
                    minimum_visibility_nm: 0.75,
                },
                ApproachProcedure {
                    name: "VOR 27R".into(),
                    kind: ApproachKind::Vor,
                    minimum_altitude_ft: 800,
                    minimum_visibility_nm: 1.5,
                },
            ],
            notams: vec![
                Notam {
                    subject: "Noise".into(),
                    text: "Noise abatement procedures in effect 22:00-06:00 local.".into(),
                    severity: NotamSeverity::Info,
                },
                Notam {
                    subject: "Construction".into(),
                    text: "Taxiway Bravo closed for repaving — use Charlie/Delta.".into(),
                    severity: NotamSeverity::Caution,
                },
            ],
            facilities: &[
                "Terminal A",
            ...
            diagram_notes:
                "Major international hub. Dual parallel runways, 20 gates across two terminals.",
        },
    );
    ...
    map.insert(
        ...
        AirportLayout {
            ...
            approaches: vec![
                ...
                ApproachProcedure {
                    name: "ILS 18".into(),
                    kind: ApproachKind::IlsCatI,
                    minimum_altitude_ft: 300,
                    minimum_visibility_nm: 0.5,
                },
                ApproachProcedure {
                    name: "RNAV 36".into(),
                    kind: ApproachKind::Rnav,
            ...
            notams: vec![Notam {
                subject: "Seaplane".into(),
                text: "Water landing area west of Rwy 18 — seaplane ops permitted.".into(),
                severity: NotamSeverity::Info,
            }],
            facilities: &[
                "Terminal",
            ...
            diagram_notes:
                "Coastal resort airport. Runway aligned N-S along the beach. Seaplane operations.",
        },
    );
        ...
        AirportLayout {
            ...
            approaches: vec![
                ApproachProcedure {
                    name: "Visual 05".into(),
                    kind: ApproachKind::Visual,
                    minimum_altitude_ft: 9000,
                    minimum_visibility_nm: 5.0,
                },
                ApproachProcedure {
                    name: "NDB 05".into(),
                    kind: ApproachKind::Ndb,
                    minimum_altitude_ft: 8500,
                    minimum_visibility_nm: 2.0,
                },
                ApproachProcedure {
                    name: "Circling".into(),
                    kind: ApproachKind::Circling,
                    minimum_altitude_ft: 9200,
                    minimum_visibility_nm: 3.0,
                },
            ],
            notams: vec![
                Notam {
                    subject: "Icing".into(),
                    text: "Moderate icing conditions reported in approach — de-icing available."
                        .into(),
                    severity: NotamSeverity::Warning,
                },
                Notam {
                    subject: "Terrain".into(),
                    text: "Mountain terrain all quadrants — maintain obstacle clearance.".into(),
                    severity: NotamSeverity::Caution,
                },
            ],
            facilities: &["Terminal", "Hotel", "De-icing Pad", "Fuel"],
            diagram_notes:
                "Mountain airport at 7,500ft. Short runway in valley — challenging approach.",
        },
    );
        ...
        AirportLayout {
            ...
            approaches: vec![
                ...
                ApproachProcedure {
                    name: "Visual 18".into(),
                    kind: ApproachKind::Visual,
                    minimum_altitude_ft: 2000,
                    minimum_visibility_nm: 3.0,
                },
            ],
            notams: vec![Notam {
                subject: "Heavy traffic".into(),
                text: "Frequent cargo operations — expect delays.".into(),
                severity: NotamSeverity::Info,
            }],
            facilities: &[
                "Terminal",
        ...
        AirportLayout {
            ...
            approaches: vec![
                ApproachProcedure {
                    name: "Visual 32".into(),
                    kind: ApproachKind::Visual,
                    minimum_altitude_ft: 7500,
                    minimum_visibility_nm: 5.0,
                },
                ApproachProcedure {
                    name: "RNAV 32".into(),
                    kind: ApproachKind::Rnav,
                    minimum_altitude_ft: 7000,
                    minimum_visibility_nm: 1.5,
                },
            ],
            notams: vec![],
            ...
            diagram_notes:
                "High-altitude airport above the cloud line. Scenic but demanding approaches.",
        },
    );
        ...
        AirportLayout {
            ...
            approaches: vec![
                ApproachProcedure {
                    name: "Visual 09".into(),
                    kind: ApproachKind::Visual,
                    minimum_altitude_ft: 3600,
                    minimum_visibility_nm: 5.0,
                },
                ApproachProcedure {
                    name: "VOR 27".into(),
                    kind: ApproachKind::Vor,
                    minimum_altitude_ft: 3400,
                    minimum_visibility_nm: 1.5,
                },
            ],
            notams: vec![Notam {
                subject: "Dust".into(),
                text: "Blowing dust may reduce visibility — use caution.".into(),
                severity: NotamSeverity::Caution,
            }],
            facilities: &["Terminal", "Hotel", "Car Rental", "Fuel"],
            diagram_notes:
                "Desert oasis airport. Long runway on flat terrain. Dust hazards possible.",
        },
    );
        ...
        AirportLayout {
            ...
            approaches: vec![
                ...
                ApproachProcedure {
                    name: "RNAV 32".into(),
                    kind: ApproachKind::Rnav,
                    minimum_altitude_ft: 700,
                    minimum_visibility_nm: 1.0,
                },
            ],
            notams: vec![Notam {
                subject: "Wind".into(),
                text: "Strong crosswinds common — check wind reports before approach.".into(),
                severity: NotamSeverity::Caution,
            }],
        ...
        AirportLayout {
            ...
            approaches: vec![
                ApproachProcedure {
                    name: "ILS 27".into(),
                    kind: ApproachKind::IlsCatI,
                    minimum_altitude_ft: 10500,
                    minimum_visibility_nm: 0.5,
                },
                ApproachProcedure {
                    name: "Visual 27".into(),
                    kind: ApproachKind::Visual,
                    minimum_altitude_ft: 11000,
                    minimum_visibility_nm: 5.0,
                },
                ApproachProcedure {
                    name: "RNAV 09".into(),
                    kind: ApproachKind::Rnav,
                    minimum_altitude_ft: 10300,
                    minimum_visibility_nm: 1.0,
                },
                ApproachProcedure {
                    name: "Circling".into(),
                    kind: ApproachKind::Circling,
                    minimum_altitude_ft: 11500,
                    minimum_visibility_nm: 3.0,
                },
            ],
            notams: vec![
                Notam {
                    subject: "Performance".into(),
                    text: "High density altitude — review performance charts before departure."
                        .into(),
                    severity: NotamSeverity::Warning,
                },
                Notam {
                    subject: "Approach".into(),
                    text: "Mountain terrain on final — strict adherence to procedure required."
                        .into(),
                    severity: NotamSeverity::Warning,
                },
            ],
            ...
            diagram_notes:
                "Elite endgame airport at 9,500ft. Long runway but thin air demands precision.",
        },
    );
