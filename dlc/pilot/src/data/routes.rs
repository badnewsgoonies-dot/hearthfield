...
pub fn all_routes() -> Vec<RouteDef> {
    vec![
        ...
        route(
            ...
            "Rolling green hills give way to the sparkling coastline.",
            35.0,
        ...
        route(
            ...
            "Flat farmland transitions to dramatic mountain peaks.",
            55.0,
        ...
        route(
            ...
            160.0,
            RouteDifficulty::Moderate,
            "Cross the central plains to the tropical southern coast.",
            95.0,
        ...
        route(
            ...
            90.0,
            RouteDifficulty::Easy,
            "Gentle terrain over industrial heartland.",
            50.0,
        ...
        route(
            ...
            400.0,
            320.0,
            RouteDifficulty::Challenging,
            "Long climb over mountain ridges to the high plateau.",
            110.0,
        ...
        route(
            ...
            230.0,
            RouteDifficulty::Challenging,
            "Cross farmland and arid plains to the desert oasis.",
            135.0,
        ...
        route(
            ...
            "Long haul over varied terrain to the weather research station.",
            165.0,
        ...
        route(
            ...
            120.0,
            RouteDifficulty::Moderate,
            "The busy route from small-town life to the big city.",
            125.0,
        ...
        route(
            ...
            45.0,
            RouteDifficulty::Expert,
            "The ultimate cross-country trek to the elite airport.",
            220.0,
        ...
        route(
            ...
            0.0,
            RouteDifficulty::Easy,
            "Coastal departure north over green hills to Clearfield.",
            35.0,
        ...
        route(
            ...
            340.0,
            RouteDifficulty::Challenging,
            "From sea level to mountain peaks — dramatic altitude change.",
            85.0,
        ...
        route(
            ...
            200.0,
            RouteDifficulty::Easy,
            "Coastal hop between two beach destinations.",
            70.0,
        ...
        route(
            ...
            60.0,
            RouteDifficulty::Easy,
            "Short hop inland to the industrial center.",
            55.0,
        ...
        route(
            ...
            330.0,
            RouteDifficulty::Challenging,
            "Long climb from coast to high altitude.",
            115.0,
        ...
        route(
            ...
            240.0,
            RouteDifficulty::Moderate,
            "Cross the interior from coast to desert.",
            125.0,
        ...
        route(
            ...
            90.0,
            RouteDifficulty::Moderate,
            "Popular commuter route to the metropolis.",
            95.0,
        ...
        route(
            ...
            30.0,
            RouteDifficulty::Expert,
            "Coast to summit — the full Skywarden experience.",
            205.0,
        ...
        route(
            ...
            170.0,
            RouteDifficulty::Moderate,
            "Descend from alpine heights to the gentle lowlands.",
            55.0,
        ...
        route(
            ...
            160.0,
            RouteDifficulty::Challenging,
            "Mountain to sea — steep descent with canyon views.",
            85.0,
        ...
        route(
            ...
            190.0,
            RouteDifficulty::Challenging,
            "Snow-capped peaks to tropical paradise.",
            130.0,
        ...
        route(
            ...
            130.0,
            RouteDifficulty::Moderate,
            "Mountain approach to industrial valley.",
            75.0,
        ...
        route(
            ...
            300.0,
            RouteDifficulty::Challenging,
            "High-altitude hop between mountain airports.",
            40.0,
        ...
        route(
            ...
            220.0,
            RouteDifficulty::Expert,
            "From frozen peaks to scorching desert.",
            150.0,
        ...
        route(
            ...
            260.0,
            RouteDifficulty::Expert,
            "Mountain to storm — turbulent and demanding.",
            110.0,
        ...
        route(
            ...
            140.0,
            RouteDifficulty::Moderate,
            "Alpine descent to the big city.",
            105.0,
        ...
        route(
            ...
            20.0,
            RouteDifficulty::Expert,
            "Peak to peak — the mountain route.",
            150.0,
        ...
        route(
            ...
            340.0,
            RouteDifficulty::Moderate,
            "North from the tropics through green plains.",
            95.0,
        ...
        route(
            ...
            20.0,
            RouteDifficulty::Easy,
            "Tropical coast to temperate coast — scenic water views.",
            70.0,
        ...
        route(
            ...
            10.0,
            RouteDifficulty::Challenging,
            "Beach to blizzard — extreme climate transition.",
            130.0,
        ...
        route(
            ...
            50.0,
            RouteDifficulty::Easy,
            "Resort to factory — contrast in destinations.",
            90.0,
        ...
        route(
            ...
            350.0,
            RouteDifficulty::Challenging,
            "Long climb from sea level to cloud height.",
            140.0,
        ...
        route(
            ...
            250.0,
            RouteDifficulty::Moderate,
            "Tropical to arid — passing through transition zones.",
            85.0,
        ...
        route(
            ...
            10.0,
            RouteDifficulty::Easy,
            "Short hop — the popular vacation route.",
            55.0,
        ...
        route(
            ...
            270.0,
            RouteDifficulty::Easy,
            "Quick return west over gentle terrain.",
            50.0,
        ...
        route(
            ...
            240.0,
            RouteDifficulty::Easy,
            "Industrial to coastal — following the river.",
            55.0,
        ...
        route(
            ...
            310.0,
            RouteDifficulty::Moderate,
            "Climb from the foundries to the frozen peaks.",
            75.0,
        ...
        route(
            ...
            230.0,
            RouteDifficulty::Easy,
            "Industrial to tropical — popular cargo route.",
            90.0,
        ...
        route(
            ...
            330.0,
            RouteDifficulty::Moderate,
            "Through the mining hills to high altitude.",
            95.0,
        ...
        route(
            ...
            210.0,
            RouteDifficulty::Moderate,
            "Major cargo corridor through varied terrain.",
            110.0,
        ...
        route(
            ...
            280.0,
            RouteDifficulty::Challenging,
            "Long industrial route west to the storm station.",
            125.0,
        ...
        route(
            ...
            110.0,
            RouteDifficulty::Easy,
            "The business shuttle — always busy.",
            70.0,
        ...
        route(
            ...
            40.0,
            RouteDifficulty::Expert,
            "Cross-country freight route to the summit.",
            180.0,
        ...
        route(
            ...
            140.0,
            RouteDifficulty::Challenging,
            "Long descent from the heights to the lowlands.",
            110.0,
        ...
        route(
            ...
            150.0,
            RouteDifficulty::Challenging,
            "Mountain to coast — dramatic descent.",
            115.0,
        ...
        route(
            ...
            120.0,
            RouteDifficulty::Challenging,
            "Short mountain hop between alpine airports.",
            40.0,
        ...
        route(
            ...
            170.0,
            RouteDifficulty::Challenging,
            "From clouds to beaches — maximum contrast.",
            140.0,
        ...
        route(
            ...
            150.0,
            RouteDifficulty::Moderate,
            "Descend from heights to the factory floor.",
            95.0,
        ...
        route(
            ...
            200.0,
            RouteDifficulty::Expert,
            "Cloud to desert — thin air to thin shade.",
            130.0,
        ...
        route(
            ...
            250.0,
            RouteDifficulty::Expert,
            "Between the mountains and the storms.",
            105.0,
        ...
        route(
            ...
            130.0,
            RouteDifficulty::Moderate,
            "From isolated heights to urban sprawl.",
            115.0,
        ...
        route(
            ...
            30.0,
            RouteDifficulty::Challenging,
            "Peak-to-peak flight over the roof of the world.",
            95.0,
        ...
        route(
            ...
            50.0,
            RouteDifficulty::Challenging,
            "Desert to green — long northward trek.",
            135.0,
        ...
        route(
            ...
            60.0,
            RouteDifficulty::Moderate,
            "Desert to coast — smell the salt air.",
            125.0,
        ...
        route(
            ...
            40.0,
            RouteDifficulty::Expert,
            "From scorching sand to frozen summit.",
            150.0,
        ...
        route(
            ...
            70.0,
            RouteDifficulty::Moderate,
            "Desert oasis to tropical beach.",
            85.0,
        ...
        route(
            ...
            30.0,
            RouteDifficulty::Moderate,
            "Cargo corridor from desert to factory.",
            110.0,
        ...
        route(
            ...
            20.0,
            RouteDifficulty::Expert,
            "Sand to sky — extreme altitude gain.",
            130.0,
        ...
        route(
            ...
            310.0,
            RouteDifficulty::Moderate,
            "Short hop between remote outposts.",
            55.0,
        ...
        route(
            ...
            60.0,
            RouteDifficulty::Moderate,
            "Desert to metropolis — land of contrasts.",
            145.0,
        ...
        route(
            ...
            100.0,
            RouteDifficulty::Expert,
            "From the storm station back to civilization.",
            165.0,
        ...
        route(
            ...
            110.0,
            RouteDifficulty::Challenging,
            "Storm to coast — often turbulent.",
            145.0,
        ...
        route(
            ...
            80.0,
            RouteDifficulty::Expert,
            "Between two of the toughest airports.",
            110.0,
        ...
        route(
            ...
            120.0,
            RouteDifficulty::Challenging,
            "Storm country to sunny beaches.",
            130.0,
        ...
        route(
            ...
            100.0,
            RouteDifficulty::Challenging,
            "Research station to industrial hub.",
            125.0,
        ...
        route(
            ...
            70.0,
            RouteDifficulty::Expert,
            "Storm to clouds — for experienced pilots only.",
            105.0,
        ...
        route(
            ...
            40.0,
            RouteDifficulty::Expert,
            "Remote to elite — the prestige route.",
            85.0,
        ...
        route(
            ...
            300.0,
            RouteDifficulty::Moderate,
            "City departure west to the quiet countryside.",
            125.0,
        ...
        route(
            ...
            320.0,
            RouteDifficulty::Moderate,
            "City to mountains — popular ski charter.",
            105.0,
        ...
        route(
            ...
            190.0,
            RouteDifficulty::Easy,
            "The vacation express — always packed.",
            55.0,
        ...
        route(
            ...
            290.0,
            RouteDifficulty::Easy,
            "Business shuttle to the industrial zone.",
            70.0,
        ...
        route(
            ...
            310.0,
            RouteDifficulty::Moderate,
            "From sea level city to mountain heights.",
            115.0,
        ...
        route(
            ...
            240.0,
            RouteDifficulty::Moderate,
            "Metropolis to remote desert — the exotic route.",
            145.0,
        ...
        route(
            ...
            280.0,
            RouteDifficulty::Challenging,
            "City to research station — for weather enthusiasts.",
            140.0,
        ...
        route(
            ...
            20.0,
            RouteDifficulty::Challenging,
            "The flagship route — Grand City to Skyreach Elite.",
            140.0,
        ...
        route(
            ...
            225.0,
            RouteDifficulty::Expert,
            "The long journey from the summit back to where it all began.",
            220.0,
        ...
        route(
            ...
            210.0,
            RouteDifficulty::Expert,
            "Elite to coast — the premium route.",
            205.0,
        ...
        route(
            ...
            200.0,
            RouteDifficulty::Expert,
            "Peak to peak — mountain mastery required.",
            150.0,
        ...
        route(
            ...
            210.0,
            RouteDifficulty::Expert,
            "From the top of the world to tropical paradise.",
            190.0,
        ...
        route(
            ...
            220.0,
            RouteDifficulty::Expert,
            "Elite to industrial — the logistics backbone.",
            180.0,
        ...
        route(
            ...
            210.0,
            RouteDifficulty::Challenging,
            "High-altitude link between elite airports.",
            95.0,
        ...
        route(
            ...
            220.0,
            RouteDifficulty::Expert,
            "Elite to research — short but treacherous.",
            85.0,
        ...
        route(
            ...
            200.0,
            RouteDifficulty::Challenging,
            "The return leg of the flagship route.",
            140.0,
...
pub fn scenic_routes() -> Vec<RouteDef> {
    all_routes().into_iter().filter(|r| r.is_scenic).collect()
}
