...
pub fn spawn_zone_objects(commands: &mut Commands, _airport: AirportId, zone: MapZone) {
    match zone {
...
fn spawn_terminal_objects(commands: &mut Commands) {
    ...
    spawn_object(
        commands,
        WorldObjectKind::VendingMachine,
        17,
        5,
        "[F] Vending Machine",
    );
