# Worker: Economy Domain (Wave 3)

## Scope (mechanically enforced — edits outside will be reverted)
You may only create/modify files under: `dlc/police/src/domains/economy/`

## Required reading (read BEFORE writing code)
1. `dlc/police/docs/spec.md` — full game spec
2. `dlc/police/docs/domains/economy.md` — YOUR domain spec (CRITICAL — read every line, all enumerative data)
...
## Deliverables
Create `dlc/police/src/domains/economy/mod.rs` with:
- `pub struct EconomyPlugin;` implementing `Plugin`
