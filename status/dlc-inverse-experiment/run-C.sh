...
Write a complete tavern.rs file. Include all types, logic, tests, and demo function."   > outputs/C/raw.log 2>&1
# Extract code from codex output
grep -v "^codex\|^Running\|^exec\|tokens used" outputs/C/raw.log > outputs/C/tavern.rs 2>/dev/null
echo "C done: $(wc -l outputs/C/tavern.rs) lines"
