...
. ~/.env_tokens
mkdir -p outputs/E
timeout 120 claude -p "# Mini-Module: Tavern Social System
...
Write a complete tavern.rs file to stdout. Include all types, logic, tests, and demo function in a single file. Output ONLY the Rust code, no explanation."   --permission-mode plan --model sonnet < /dev/null > outputs/E/tavern.rs 2>outputs/E/stderr.log
echo "E done: $(wc -l outputs/E/tavern.rs) lines"
